...
{   
    ...
    public function mount($id)
    {
        ...
        if($customer) {
            ...
            $this->customer_ktp_image = $customer->customer_ktp_image;
            $this->customer_npwp_image = $customer->customer_npwp_image;
            $this->customer_sppkp_image = $customer->customer_sppkp_image;
            $this->customer_store1_image = $customer->customer_store1_image;
            $this->customer_store2_image = $customer->customer_store2_image;
    ...
    {   
        ...
        if(!empty($this->customer_ktp_image)){
        ...
        if(!empty($this->customer_npwp_image)){
        ...
        if(!empty($this->customer_sppkp_image)){
        ...
        if(!empty($this->customer_store1_image)){
        ...
        if(!empty($this->customer_store2_image)){
    ...
    {
        return view('livewire.data.customers.edit');
    }
}
